              ...
              <el-card :body-style="{ padding: '0px' }" >
                ...
                <div style="padding: 14px;" @click="publicDetail(pub.id)">
                  ...
                  <el-row class="cardGyDiv">
                    ...
                    <el-col :span="8">
                      <div>
                        <el-tag type="success" class="cardTag" @click="judgeDetail(pub.id)">查看详情</el-tag>
                      </div>
                    </el-col>
                  </el-row>
                </div>
            ...
            <el-card class="box-card">
              ...
              <el-carousel indicator-position="outside" class="carousel">
                <el-carousel-item v-for="(o, index) in latestDontateList" :key="index">
                  <div>捐款人：&nbsp;&nbsp;&nbsp;&nbsp;{{o.createdUserName}}</div>
                  <div>捐款金额：{{o.money}}元</div>
                  <div>捐款项目：{{o.title}}</div>
                  <div></div>
                </el-carousel-item>
              </el-carousel>
            </el-card>
          ...
          <el-card :body-style="{ padding: '0px' }">
            ...
            <el-row>
              <el-col :span="5" v-for="person in personListData" :key="person.id" style="margin: 20px">
                <el-card>
                  <div >
                    <el-image :src="person.filePath" lazy style="height: 179px;width: 319px;" fit="fill"/>
                  </div>
                  ...
                  <div style="padding: 14px;">
                    ...
                    <el-row class="cardGyDiv">
                      <el-col :span="24">
                        <p>学校：{{ person.school }} </p>
                        <p>城市：{{ person.cityText }}</p>
                      </el-col>
                    </el-row>
                    <el-row class="cardGyDiv">
                    <el-col :span="8">
                      <div style="width: 50px">
                        <el-button round  @click="judgeDetail(person.applyId)" v-if="person.applyId>0">查看活动</el-button>
                        <el-button round @click="addapply(person.id)" v-if="person.applyId==0" >创建活动</el-button>
                      </div>
                    </el-col>
                  </el-row>
                  </div>
...
export default {
  ...
  methods: {
    ...
    // 获取本地帮扶列表
    getPersonList () {
      getChild(this.personQuery).then(re => {
