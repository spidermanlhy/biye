  ...
  <div>
    <el-tabs v-model="activeName" >
      <el-tab-pane label="公益项目"  name="first">
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-input v-model="search_param.title" placeholder="请输入项目标题"></el-input>
          </el-col>
          <el-col :span="8">
        ...
        <el-row>
          <el-col :span="5" v-for="apply in public_apply" :key="apply.id" style="margin: 20px;height: 450px">
            <el-badge :value="apply.statusName" class="item">
              <el-card>
                <div  @click="judgeDetail(apply.id)">
                ...
                <div style="padding: 14px;">
                  ...
                  <el-row class="cardGyDiv">
                    <el-col :span="16">
                      <el-button round  @click="judgeDetail(apply.id)">查看项目</el-button>
                    </el-col>
                  </el-row>
                </div>
              </el-card>
            ...
            <el-badge :value="apply.statusName" class="item">
              <el-card>
                ...
                <div style="padding: 14px;">
                  ...
                  <el-row class="cardGyDiv">
                    <el-col :span="16">
                      <el-button round  @click="judgeDetail(apply.id)">查看活动</el-button>
                    </el-col>
                  </el-row>
                </div>
              </el-card>
...
export default {
  ...
  methods: {
    myApplyList () {
      getApplyList(this.search_param).then(re => {
        console.log(re)
    ...
    myApplyList2 () {
      getApplyList(this.search_param2).then(re => {
        console.log(re)
