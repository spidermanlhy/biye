  ...
  <el-container>
          ...
          <el-breadcrumb separator-class="el-icon-arrow-right" style="line-height:5vh;">
            ...
            <el-dropdown style="float:right;line-height:5vh;padding-right:1vw" @command="handleNavCommand">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item divided command="register">创建管理员</el-dropdown-item>
      ...
      <el-dialog class="adminRegister" title="管理员用户注册" :visible.sync="dialogFormVisible">
        <el-form :rules="rules" ref="adminRegisterForm" :model="adminRegisterForm">
          ...
          <el-form-item label='性别:' :label-width="formLabelWidth" prop="title">
            <el-col :lg="15" :xl="12">
              <el-select v-model="adminRegisterForm.sex" placeholder="请选择" >
                <el-option
                  v-for="item in sex"
                  :key="item.value"
                  :label="item.label"
          ...
          <el-form-item label="手机号" :label-width="formLabelWidth" prop="phone">
            <el-input v-model="adminRegisterForm.phone" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="邮箱" :label-width="formLabelWidth" prop="mail">
            <el-input v-model="adminRegisterForm.mail" autocomplete="off"></el-input>
          </el-form-item>
...
import {register, sysRegist} from '../../service/api'
export default {
  name: 'admin_layout',
  provide () {
    return {
    ...
    submitAdminRegisterForm () {
      this.$refs['adminRegisterForm'].validate(valid => {
        ...
        //  this.adminRegisterForm
          register(this.adminRegisterForm).then(re => {
            if(re.success){
              this.$message({
                type: 'success',
                message: '注册成功'
